...
## 1) Criterion **1**: Capability Maturity Model Integration (CMMI) Level 3 or greater
...
## 2) Criterion **2**: International Organization for Standardization (ISO) 9001:2015
...
### 3.2) Criterion **4**: Demonstrate Experience with at Least Three (3) Projects Implementing and Upgrading Oracle Federal Financials
...
### 3.3) Criterion **3**: CSP and Key Technology Partnerships
###      Criterion **5** Demonstrate Experience with at Least Two (2) Projects Leading Supporting Cloud Migration/Transformation
...
## 4) Criterion 6: Demonstrate Experience with at Least Two (2) or More FedRAMP Operational Expertise
