...
## Load CVS files for companies filtered based on ISO 9001:2015 and >= ML3 and SAM+ and >= 1 CSP (seee CSP and Key Tech Partnerships on Factor 1 criteria)


## Unzip and load all awards data for FY2021 from [www.usaspending.gov](https://files.usaspending.gov/generated_downloads/PrimeAwardSummariesAndSubawards_2021-01-14_H05M14S15472571.zip)

- [Prime Award Summaries and Subawards](https://files.usaspending.gov/generated_downloads/PrimeAwardSummariesAndSubawards_2021-01-14_H05M14S15472571.zip)

- [Prime Transactions and Subawards](https://files.usaspending.gov/generated_downloads/PrimeTransactionsAndSubawards_2021-01-14_H05M15S03062502.zip)
...
awards_fy21 <- read_csv("PrimeAwardSummariesAndSubawards_2021-01-14_H05M14S15472571/Contracts_PrimeAwardSummaries_2021-01-14_H05M14S17_1.csv")
...
cmmi$x <- gsub(paste(to_remove_cmmi,collapse="|"),"",as.character(cmmi$Name))
...
countries_select <- countries_cmmi %>%
  ...
  select(`unlist(country)`, Name, y, sam_status, cmmi_level)
colnames(countries_select) <- c("country", "Name", "y", "sam_status", "cmmi_level")
...
cmmi_duns_award_select <- dplyr::select(cmmi_duns_award, y, award_description, recipient_duns, naics_code_cmmi, naics_description, sam_status, cmmi_level, cage_code_cmmi)
